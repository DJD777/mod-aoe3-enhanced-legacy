...
//spawnSwitch = 0.1;
	...
	if (isObserverMode == true)
	{
		...
		{ //1v1
			rmSetRandomSpawn1v1(0.225, 0.71,  0.775, 0.29);
		}
		else if (rmGetPlayerTeam(2)!=rmGetPlayerTeam(3))
		{ // 2v2
			rmSetRandomSpawn2v2(0.25, 0.71, 0.25, 0.45,  0.75, 0.29, 0.75, 0.55);
		}
		else if (rmGetPlayerTeam(3)!=rmGetPlayerTeam(4))
		{ // 3v3
			rmSetRandomSpawn3v3(0.25, 0.72, 0.25, 0.35, 0.25, 0.535,  0.75, 0.28, 0.75, 0.65, 0.75, 0.465);
	...
	//*************ffa placement********
	   ...
	   rmSetAreaMix(continent2, "greatlakes_grass");
...
//==========native island placement===============
	...
	if (TeamNum == 2){
        ...
        rmSetAreaTerrainType(lakeWest, "california\desert5_cal");
	...
	if (TeamNum == 2){
        ...
        rmSetAreaTerrainType(lakeEast, "california\desert5_cal");
	...
	if (PlayerNum >= 4)
{
	...
	if (TeamNum == 2){
        ...
        rmSetAreaTerrainType(lakeSE, "california\desert5_cal");
	...
	if (TeamNum == 2){
        ...
        rmSetAreaTerrainType(lakeSW, "california\desert5_cal");
...
//==========random lakes==============
	...
	for (j=0; < (9*PlayerNum)) {   
        ...
        rmSetAreaWaterType(ffaCliffs, "new england lake");
...
for(j=0; < 4 ) {
   int centreIslands = rmCreateArea("centre islands"+j);
        ...
        rmSetAreaBaseHeight(centreIslands, 0.0);
...
//top & bottom
	...
	rmAddObjectDefConstraint(playerStart, avoidWaterShort);
        ...
        rmAddObjectDefItem(treeID, "underbrushTexasGrass", rmRandInt(3,4), 9.0);
        rmAddObjectDefItem(treeID, "TreePonderosaPine", rmRandInt(9,10), 6.0);
	...
	rmAddObjectDefConstraint(foodID, avoidWaterShort);	
        ...
        rmAddObjectDefItem(foodID2, "deer", 5, 6.0);
...
//	rmAddObjectDefConstraint(nuggetID, avoidTownCenterMore); 
	...
	rmPlaceObjectDefAtLoc(fishID, 0, 0.5, 0.5, 35*PlayerNum);   



		int bonusTrees=rmCreateObjectDef("bonusTrees");
		rmAddObjectDefItem(bonusTrees, "TreePonderosaPine", rmRandInt(6,7), rmRandFloat(11.0,12.0));
	rmAddObjectDefItem(bonusTrees, "TreeGreatPlains", rmRandInt(3,4), 10.0);
	rmAddObjectDefItem(bonusTrees, "underbrushTexasGrass", rmRandInt(6,7), 12.0);
