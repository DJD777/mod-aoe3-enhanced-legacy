...
void main(void)
{
   ...
   for(i=1; <numPlayer)
   {
	...
	topleftVillageID = rmCreateGrouping("Inca village Top Left", "native inca village "+rmRandInt(1,3));
	...
	bottomleftVillageID = rmCreateGrouping("Inca village Bottom Left", "native inca village "+rmRandInt(1,3));
	...
	topRightVillageID = rmCreateGrouping("Inca village Top Right", "native inca village "+rmRandInt(1,3));
	...
	bottomRightVillageID = rmCreateGrouping("Inca village Bottom Right", "native inca village "+rmRandInt(1,3));
