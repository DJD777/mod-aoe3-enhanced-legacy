...
void main(void)
{
  ...
  int avoidTC = rmCreateTypeDistanceConstraint("avoid TCs", "TownCenter", 36.0);
  ...
  int avoidFoodMid = rmCreateClassDistanceConstraint("avoid foods mid", foodClass, 32.0);
  ...
  int avoidHerdables=rmCreateTypeDistanceConstraint("avoids cattle", "ypWaterBuffalo", 52.0); 
  ...
  //~ randomRiver = 1;
	...
	if (isObserverMode == true) {
		...
		if (whichVersion == 1 && randomRiver == 1) {
			if (rmGetPlayerTeam(1) != rmGetPlayerTeam(2)) { //1v1
				rmSetRandomSpawn1v1(0.2376, 0.7464, 0.7624, 0.2536);
			} else if (rmGetPlayerTeam(2) != rmGetPlayerTeam(3)) { // 2v2
				rmSetRandomSpawn2v2(0.3888, 0.8424, 0.1464, 0.5675, 0.8424, 0.3888, 0.5675, 0.1464);
			} else if (rmGetPlayerTeam(3) != rmGetPlayerTeam(4)) { // 3v3
				rmSetRandomSpawn3v3(0.2300, 0.7381, 0.3888, 0.8424, 0.1464, 0.5675, 0.7381, 0.2300, 0.8424, 0.3888, 0.5675, 0.1464);
			}
		} else if (whichVersion == 1 && randomRiver == 2) {
			if (rmGetPlayerTeam(1) != rmGetPlayerTeam(2)) { //1v1
				rmSetRandomSpawn1v1(0.2376, 0.7464, 0.7624, 0.2536);
			} else if (rmGetPlayerTeam(2) != rmGetPlayerTeam(3)) { // 2v2
				rmSetRandomSpawn2v2(0.1653, 0.6325, 0.4549, 0.8572, 0.8572, 0.4549, 0.6325, 0.1653);
			} else if (rmGetPlayerTeam(3) != rmGetPlayerTeam(4)) { // 3v3
				rmSetRandomSpawn3v3(0.4549, 0.8572, 0.1653, 0.6325, 0.2794, 0.7845, 0.6325, 0.1653, 0.8572, 0.4549, 0.7845, 0.2794);
			}
		} else if (whichVersion == 2 && randomRiver == 1) {
			if (rmGetPlayerTeam(1) != rmGetPlayerTeam(2)) { //1v1
				rmSetRandomSpawn1v1(0.7912, 0.7116, 0.2226, 0.2705);
			} else if (rmGetPlayerTeam(2) != rmGetPlayerTeam(3)) { // 2v2
				rmSetRandomSpawn2v2(0.6325, 0.8347, 0.8571, 0.5451, 0.4325, 0.1464, 0.1576, 0.3888);
			} else if (rmGetPlayerTeam(3) != rmGetPlayerTeam(4)) { // 3v3
				rmSetRandomSpawn3v3(0.8571, 0.5451, 0.6325, 0.8347, 0.7845, 0.7206, 0.1576, 0.3888, 0.4325, 0.1464, 0.2619, 0.2300);
			}
		} else {
			if (rmGetPlayerTeam(1) != rmGetPlayerTeam(2)) { //1v1
				rmSetRandomSpawn1v1(0.7912, 0.7116, 0.2226, 0.2705);
			} else if (rmGetPlayerTeam(2) != rmGetPlayerTeam(3)) { // 2v2
				rmSetRandomSpawn2v2(0.5675, 0.8536, 0.8424, 0.6112, 0.3675, 0.1653, 0.1428, 0.4549);
			} else if (rmGetPlayerTeam(3) != rmGetPlayerTeam(4)) { // 3v3
				rmSetRandomSpawn3v3(0.5675, 0.8536, 0.8424, 0.6112, 0.7381, 0.7700, 0.1428, 0.4549, 0.2155, 0.2794, 0.3675, 0.1653);
			}
		}
	} else {
  ...
  rmSetAreaCliffEdge(startingCliff1, 6, .13, 0, 1.0, 0); // .14
  if(TeamNum == 2)
  ...
  if(PlayerNum > 3 || randomRiver == 1) {
    if(TeamNum > 2 && PlayerNum == 3) {
  ...
  rmSetObjectDefMinDistance(TCID, 0.0);
	rmSetObjectDefMaxDistance(TCID, 2.0);
...
//  rmAddObjectDefConstraint(rightSilverID, avoidWater10);
  ...
  for (i=0; <numTries) {   
    ...
    rmSetAreaForestDensity(forest, 0.60);
  ...
  for (i=0; <numTries) {   
    ...
    rmSetAreaForestDensity(outerForest, 0.40);
  ...
  rmPlaceObjectDefAtLoc(food2ID, 0, 0.5, 0.5, 5*PlayerNum);
  
  foodCount = rmRandInt(2,2);
  
  int food3ID=rmCreateObjectDef("ephelants!");
  rmAddObjectDefItem(food3ID, "ypWildElephant", foodCount, 4.0);
  ...
  rmPlaceObjectDefAtLoc(food3ID, 0, 0.5, 0.5, 2*PlayerNum);
  ...
  rmPlaceObjectDefAtLoc(herdID, 0, 0.5, 0.5, PlayerNum*2);
  ...
  rmPlaceObjectDefAtLoc(berriesID, 0, 0.5, 0.5, PlayerNum*4);
  ...
  rmPlaceObjectDefAtLoc(crazyNugget, 0, 0.5, 0.5, PlayerNum);
  ...
  rmPlaceObjectDefAtLoc(hardNugget, 0, 0.5, 0.5, PlayerNum);
  ...
  rmPlaceObjectDefAtLoc(mediumNugget, 0, 0.5, 0.5, PlayerNum*2);
  ...
  rmPlaceObjectDefAtLoc(easyNugget, 0, 0.5, 0.5, PlayerNum*3);
  
  // Team nuggets
  if(TeamNum == 2 && PlayerNum > 2){
    rmSetNuggetDifficulty(12, 12);
	  rmPlaceObjectDefAtLoc(easyNugget, 0, 0.5, 0.5, PlayerNum);
  }
