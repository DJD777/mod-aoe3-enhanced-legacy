...
// ------------------------------------------------------ Player Location and Specific Area ---------------------------------------------------------------------------
	...
	if (isObserverMode == true)
	{
		...
		{ //1v1
			rmSetRandomSpawn1v1(0.55,0.85,  0.45,0.15);
		}
		else if (rmGetPlayerTeam(2)!=rmGetPlayerTeam(3))
		{ // 2v2
			rmSetRandomSpawn2v2(0.54,0.85,  0.85,0.52,  0.46,0.15,  0.15,0.48);
		}
		else if (rmGetPlayerTeam(3)!=rmGetPlayerTeam(4))
		{ // 3v3
			rmSetRandomSpawn3v3(0.76,0.74,  0.54,0.85,  0.85,0.52,  0.24,0.26,  0.46,0.15,  0.15,0.48);
		}
	}
	else
	{
   ...
   if (isWinterSeason == true) {
		...
		rmSetAreaMix(newGrass, "california_grass");
   }
   ...
   if (isWinterSeason == true) {
		...
		rmSetAreaMix(newGrass2, "california_grass");
   }
   ...
   if (isWinterSeason == true) {
		...
		rmSetAreaTerrainType(newGrass3, "california\ground7_cal");
		rmSetAreaMix(newGrass3, "california_grass");
   }
...
if(PlayerNum ==2)
{
	  ...
	  if (isWinterSeason == true) {
		  ...
		  rmSetAreaWaterType(smallPondID, "california coast");
	  }
      ...
      rmSetAreaMaxBlobDistance(smallPondID, 1.0);
	  ...
	  if (isWinterSeason == true) {
		  ...
		  rmSetAreaWaterType(smallPondID2, "california coast");
	  }
      rmSetAreaBaseHeight(smallPondID2, 4);
      rmSetAreaMinBlobs(smallPondID2, 1);
      rmSetAreaMaxBlobs(smallPondID2, 1);
      rmSetAreaMinBlobDistance(smallPondID2, 0.0);
      rmSetAreaMaxBlobDistance(smallPondID2, 1.0);
...
if (PlayerNum >2)
{
   ...
   {		
      ...
      rmSetAreaWaterType(smallPondID3, "california coast");
      rmSetAreaBaseHeight(smallPondID3, 4);
      rmSetAreaMinBlobs(smallPondID3, 1);
      rmSetAreaMaxBlobs(smallPondID3, 1);
      rmSetAreaMinBlobDistance(smallPondID3, 0.0);
      rmSetAreaMaxBlobDistance(smallPondID3, 1.0);
  ...
  // RANDOM TREES
   ...
   rmAddObjectDefItem(DeerID, "Deer", rmRandInt(9,12), 8.0);
   ...
   rmAddObjectDefItem(DeerID1, "Deer", rmRandInt(9,12), 8.0);
   ...
   rmAddObjectDefItem(DeerID4, "Deer", rmRandInt(9,12), 8.0);
