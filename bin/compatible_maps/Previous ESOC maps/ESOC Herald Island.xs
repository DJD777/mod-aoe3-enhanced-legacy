...
void main(void)
{
	...
	string MixType = "rockies_grass_snowb";
...
// ************* TradeRoute & Center Island **************************************	
   ...
   bool placedTradeRoute = rmBuildTradeRoute(tradeRouteID, "snow");
    ...
    rmSetAreaCliffHeight(centerIsland, 18, 0.0, 0.5);
...
//****************** La pente *************************************	
	...
	rmSetAreaMix(rightPart, "araucania_snow_a");
 //   rmSetAreaHeightBlend(rightPart, 0);
	...
	int stayRightPart=rmCreateAreaConstraint("rester sur la partie penchee", rightPart);
		...
		rmSetAreaForestType(forest2, "z64 Alaskan Mountains");
...
// ********* The little Way ***************************	
	...
	rmSetAreaBaseHeight(littleGap, 5.0);
...
// --------------------------------------------- Starting Ressources --------------------------  
	...
	if (isObserverMode == true)
	{
		...
		{ //1v1
			rmSetRandomSpawn1v1(0.22,0.57,0.78,0.57);
		}
		else if (rmGetPlayerTeam(2)!=rmGetPlayerTeam(3))
		{ // 2v2
			rmSetRandomSpawn2v2(0.22,0.65, 0.22,0.45,0.78, 0.65, 0.78,0.45);
		}
		else if (rmGetPlayerTeam(3)!=rmGetPlayerTeam(4))
		{ // 3v3
			rmSetRandomSpawn3v3(0.22,0.65, 0.22,0.45,  0.22,0.55,  0.78, 0.25, 0.78,0.45,  0.78,0.55);
		}
	}
	else
	{
   ...
   for(i=1; <numPlayer)
   {
		...
		rmSetAreaTerrainType(id, "yukon\ground3x_yuk");
   ...
   for(i=1; <numPlayer)
   {
		...
		rmSetAreaTerrainType(id1, "yukon\ground3_yuk");
	...
	rmAddObjectDefItem(startSilverID2, "MineTin", 1, 5.0);
...
// **************************** Hunts*******************************
	...
	rmAddObjectDefItem(CaribouID, "caribou", rmRandInt(9,10), 10.0);
...
//	rmAddObjectDefConstraint(CaribouID, PromontoirHunts);
	...
	rmAddObjectDefItem(MuskOXID, "muskOx", rmRandInt(9,10), 10.0);
