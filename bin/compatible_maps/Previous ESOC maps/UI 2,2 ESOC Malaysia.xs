...
void main(void)
{
  ...
  string forestTypeSpecial = "z58 Indian Jungle"; // special forest only available on EP
  if (false == false)
  {
...
// --------------------------------------------------- STARTING LOCATION ----------------------------------------------------------	
	...
	if (isObserverMode == true)
	{
		...
		{ //1v1
			rmSetRandomSpawn1v1(0.75, 0.5,0.25,0.5);
		}
		else if (rmGetPlayerTeam(2)!=rmGetPlayerTeam(3))
		{ // 2v2
			rmSetRandomSpawn2v2(0.78,0.52,  0.52,0.78,  0.22,0.48,  0.48,0.22);
		}
		else if (rmGetPlayerTeam(3)!=rmGetPlayerTeam(4))
		{ // 3v3
			rmSetRandomSpawn3v3(0.78,0.52,  0.52,0.78,  0.6,0.6,  0.22,0.48,  0.48,0.22,  0.4,0.4);
		}
	}
	else
	{
		if (cNumberNonGaiaPlayers==2)
	   {
		...
		rmPlacePlayer(1, 0.25, 0.5);
		}
		else
		{
		rmPlacePlayer(1, 0.75, 0.5);
		rmPlacePlayer(2, 0.25, 0.5);
		}
	   }
	   else
	   {
	   rmSetPlacementTeam(0);
	   rmPlacePlayersLine(0.78,0.52,0.52,0.78,0,0);

	   rmSetPlacementTeam(1);
	   rmPlacePlayersLine(0.22,0.48,0.48,0.22,0,0);
	   }
	}
