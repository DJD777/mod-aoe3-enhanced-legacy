...
void main(void)
{
	...
	*/
	...
	{	
			...
			botVillageID = rmCreateGrouping("inca bot 1", "native inca village " + 2);
			...
			botVillageID = rmCreateGrouping("inca village 2", "native inca village " + 2);
			rmSetGroupingMinDistance(botVillageID, 0.0);
			rmSetGroupingMaxDistance(botVillageID, 0.5);
			rmAddGroupingToClass(botVillageID, rmClassID("classNatives"));
			...
			//native jesuit mission cj 0 , native jesuit mission borneo 0
			botVillageID = rmCreateGrouping("inca bot 3", "native inca village " + 2);
			rmSetGroupingMinDistance(botVillageID, 0.0);
			rmSetGroupingMaxDistance(botVillageID, 0.5);
			rmAddGroupingToClass(botVillageID, rmClassID("classNatives"));
			rmPlaceGroupingAtLoc(botVillageID, 0, 0.83, 0.31);
			
			botVillageID = rmCreateGrouping("inca village 4", "native inca village " + 2);
			rmSetGroupingMinDistance(botVillageID, 0.0);
			rmSetGroupingMaxDistance(botVillageID, 0.5);
			rmAddGroupingToClass(botVillageID, rmClassID("classNatives"));
	...
	if(PlayerNum == 4)
	{
			botVillageID = rmCreateGrouping("inca village 23", "native inca village " + 2);
			rmSetGroupingMinDistance(botVillageID, 0.0);
			rmSetGroupingMaxDistance(botVillageID, 0.5);
			rmAddGroupingToClass(botVillageID, rmClassID("classNatives"));
			rmPlaceGroupingAtLoc(botVillageID, 0, 0.27, 0.5);
			
			botVillageID = rmCreateGrouping("inca village 24", "native inca village " + 2);
			rmSetGroupingMinDistance(botVillageID, 0.0);
			rmSetGroupingMaxDistance(botVillageID, 0.5);
			rmAddGroupingToClass(botVillageID, rmClassID("classNatives"));		
		...
		if(spawnSwitch2 <= 0.6)
		{
			...
			botVillageID = rmCreateGrouping("inca village 55", "native inca village " + 1);
			rmSetGroupingMinDistance(botVillageID, 0.0);
			rmSetGroupingMaxDistance(botVillageID, 0.5);
			rmAddGroupingToClass(botVillageID, rmClassID("classNatives"));
		...
		{	
			botVillageID = rmCreateGrouping("inca village 44", "native inca village " + 4);
			rmSetGroupingMinDistance(botVillageID, 0.0);
			rmSetGroupingMaxDistance(botVillageID, 0.5);
			rmAddGroupingToClass(botVillageID, rmClassID("classNatives"));
		...
		if(spawnSwitch3 <= 0.6)
		{		
			botVillageID = rmCreateGrouping("inca village 56", "native inca village " + 1);
			rmSetGroupingMinDistance(botVillageID, 0.0);
			rmSetGroupingMaxDistance(botVillageID, 0.5);
			rmAddGroupingToClass(botVillageID, rmClassID("classNatives"));
		...
		{
			botVillageID = rmCreateGrouping("inca village 45", "native inca village " + 4);
			rmSetGroupingMinDistance(botVillageID, 0.0);
			rmSetGroupingMaxDistance(botVillageID, 0.5);
			rmAddGroupingToClass(botVillageID, rmClassID("classNatives"));
	...
	if(PlayerNum == 6)
	{
		if(spawnSwitch0 <= 0.6)
		{
			botVillageID = rmCreateGrouping("inca village 23000", "native inca village " + 2);
			rmSetGroupingMinDistance(botVillageID, 0.0);
			rmSetGroupingMaxDistance(botVillageID, 0.5);
			rmAddGroupingToClass(botVillageID, rmClassID("classNatives"));
			rmPlaceGroupingAtLoc(botVillageID, 0, 0.27, 0.7);
			
			botVillageID = rmCreateGrouping("inca village 56000", "native inca village " + 1);
			rmSetGroupingMinDistance(botVillageID, 0.0);
			rmSetGroupingMaxDistance(botVillageID, 0.5);
			rmAddGroupingToClass(botVillageID, rmClassID("classNatives"));
		...
		{
			botVillageID = rmCreateGrouping("inca village 23001", "native inca village " + 1);
			rmSetGroupingMinDistance(botVillageID, 0.0);
			rmSetGroupingMaxDistance(botVillageID, 0.5);
			rmAddGroupingToClass(botVillageID, rmClassID("classNatives"));
			rmPlaceGroupingAtLoc(botVillageID, 0, 0.27, 0.3);
			
			botVillageID = rmCreateGrouping("inca village 56001", "native inca village " + 1);
			rmSetGroupingMinDistance(botVillageID, 0.0);
			rmSetGroupingMaxDistance(botVillageID, 0.5);
			rmAddGroupingToClass(botVillageID, rmClassID("classNatives"));
			rmPlaceGroupingAtLoc(botVillageID, 0, 0.27, 0.7);	
