...
int RealP1FromWest = 1;
int RealP2FromWest = 2;
int RealP3FromWest = 3;
int RealP4FromWest = 4;
int RealP5FromWest = 5;
int RealP6FromWest = 6;

int RealP1FromNorth = 1;
int RealP2FromNorth = 2;
int RealP3FromNorth = 3;
int RealP4FromNorth = 4;
int RealP5FromNorth = 5;
int RealP6FromNorth = 6;

int rPFromWest(int position = 1)
{
	if (position == 1)
	{
		return (RealP1FromWest);
	}
	if (position == 2)
	{
		return (RealP2FromWest);
	}
	if (position == 3)
	{
		return (RealP3FromWest);
	}
	if (position == 4)
	{
		return (RealP4FromWest);
	}
	if (position == 5)
	{
		return (RealP5FromWest);
	}
...
int rPFromNorth(int position = 1)
{
	if (position == 1)
	{
		return (RealP1FromNorth);
	}
	if (position == 2)
	{
		return (RealP2FromNorth);
	}
	if (position == 3)
	{
		return (RealP3FromNorth);
	}
	if (position == 4)
	{
		return (RealP4FromNorth);
	}
	if (position == 5)
	{
		return (RealP5FromNorth);
	}
...
void AEU(int unitid = 0, string unit = "Settler", int strid = 0, string imgpath = "")
{
	if (unitid > -1 && unit > "")
	{
		cEf(" AEU(" + cNumAllTypes + "," + unitid + ",\"" + unit + "\"," + strid + ",\"" + imgpath + "\"); ");
	}
	else if (unitid > -1)
	{
		cEf(" AEU(" + cNumAllTypes + "," + unitid + ",kbGetProtoUnitName(" + unitid + ")," + strid + ",\"" + imgpath + "\"); ");
	}
	else
	{
		cEf(" AEU(" + cNumAllTypes + ",kbGetProtoUnitID(\"" + unit + "\"),\"" + unit + "\"," + strid + ",\"" + imgpath + "\"); ");
	}
	cNumEcoTypes++;
	cNumAllTypes++;
}
...
void ITT(int techid = 0, int strid = 0, string imgpath = "", string technm = "")
{
	if (technm > "")
	{
		cEf(" ITT(kbGetTechID(\"" + technm + "\")," + strid + ",\"" + imgpath + "\"); ");
	}
	else
	{
		cEf(" ITT(" + techid + "," + strid + ",\"" + imgpath + "\"); ");
	}
}
void ITS(int techid = 0, int strid = 0, string imgpath = "", string technm = "")
{
	if (technm > "")
	{
		cEf(" ITS(kbGetTechID(\"" + technm + "\")," + strid + ",\"" + imgpath + "\"); ");
	}
	else
	{
		cEf(" ITS(" + techid + "," + strid + ",\"" + imgpath + "\"); ");
	}
}
...
{
	if (unittypenm > "" && technm > "")
	{
		cEf(" ATT(" + cNumTrackedTechs + ",", "kbGetUnitTypeID(\"" + unittypenm + "\"),kbGetTechID(\"" + technm + "\")); ");
	}
	else if (technm > "")
	{
		cEf(" ATT(" + cNumTrackedTechs + ",", "" + unittypeid + ",kbGetTechID(\"" + technm + "\")); ");
	}
	else if (unittypenm > "")
	{
		cEf(" ATT(" + cNumTrackedTechs + ",", "kbGetUnitTypeID(\"" + unittypenm + "\")," + techid + "); ");
	}
	else
	{
		if (techid < 0)
		{
			cEf(" ATT(" + cNumTrackedTechs + "," + unittypeid + ",", "" + (-1 * techid) + ",1); ");
		}
		else
		{
			cEf(" ATT(" + cNumTrackedTechs + "," + unittypeid + ",", "" + techid + ",0); ");
		}
	}
	cNumTrackedTechs++;
}
...
void ATTR(int unittypeid = 0, int techid = 0, string unittypenm = "", string technm = "")
{
	if (unittypenm > "" && technm > "")
	{
		cEf(" ATTR(" + cNumTrackedTechsRemoved + ",", "kbGetUnitTypeID(\"" + unittypenm + "\"),kbGetTechID(\"" + technm + "\")); ");
	}
	else if (technm > "")
	{
		cEf(" ATTR(" + cNumTrackedTechsRemoved + ",", "" + unittypeid + ",kbGetTechID(\"" + technm + "\")); ");
	}
	else if (unittypenm > "")
	{
		cEf(" ATTR(" + cNumTrackedTechsRemoved + ",", "kbGetUnitTypeID(\"" + unittypenm + "\")," + techid + "); ");
	}
	else
	{
		cEf(" ATTR(" + cNumTrackedTechsRemoved + "," + unittypeid + ",", "" + techid + "); ");
	}
...
string configVar(int index = 0)
{
	...
	case 0:
		return ("numLFs");
	case 1:
		return ("shpdetailsstarter2");
	case 2:
		return ("shpbarstarter2");
	case 3:
		return ("shpdetailsstarter4");
	case 4:
		return ("shpbarstarter4");
	case 5:
		return ("headerstarter");
	case 6:
		return ("gstarter");
	case 7:
		return ("sbdeadspace");
	case 8:
		return ("shpbarlength");
	case 9:
		return ("shpbarspacing");
	case 10:
		return ("shpdetailsspacing");
	case 11:
		return ("reslinespacing");
	case 12:
		return ("graphiclength");
	case 13:
		return ("Glinewidth");
	case 14:
		return ("SectionWidth2");
	case 15:
		return ("SectionWidth4");
	case 16:
		return ("blanklabelwidth");
	case 17:
		return ("Gcellwidth");
	case 18:
		return ("dividerW");
	...
	case 27:
		return ("disT2");
	case 28:
		return ("tpsubspacing2");
	case 29:
		return ("tpbigspacing2");
	case 30:
		return ("tpsubspacing4");
	case 31:
		return ("tpbigspacing4");
	case 32:
		return ("shpdetailsstarter6"); ///
	case 33:
		return ("shpbarstarter6");
	case 34:
		return ("startliner");
	case 35:
		return ("newliner");
	case 36:
		return ("newdoubleliner");
	case 37:
		return ("displayfinetuning");
	default:
		return ("");
	}
	return ("");
...
void main(void)
{
	...
	rmSetSeaLevel(0.0);
	rmSetMapElevationParameters(cElevTurbulence, 0.06, 4, 0.4, 3.0);
	...
	int avoidAllLarge = rmCreateTypeDistanceConstraint("avoid all large", "all", 10.0);

	int forestConstraint = rmCreateClassDistanceConstraint("forest vs. forest", rmClassID("classForest"), 25.0);
	int forestConstraintSmall = rmCreateClassDistanceConstraint("forest vs. forest small", rmClassID("classForest"), 15.0);
	int avoidTownCenter1 = rmCreateTypeDistanceConstraint("avoid Town Center", "townCenter", 27.0);
	int avoidTownCenterFar = rmCreateTypeDistanceConstraint("avoid Town Center", "townCenter", 50.0);
	...
	rmAddAreaInfluenceSegment(terrainMix2, 0.2, 0, 0.2, 1.0);
	rmSetAreaCoherence(terrainMix2, 0.8);
	rmSetAreaSize(terrainMix2, 0.5, 0.5);
	rmSetAreaMix(terrainMix2, "araucania_north_grass_c");
	...
	rmAddAreaInfluenceSegment(cliffID, 0.14, 0.5, 0.35, 0.5);
	...
	if (rmRandFloat(0, 1) > 0.5)
	{
		...
		rmSetAreaSize(NorthIsland, 0.016, 0.016); // 0.38 0.47
		rmSetAreaSmoothDistance(NorthIsland, 7);
		rmSetAreaMix(NorthIsland, "araucania_north_grass_b");
		...
		rmAddObjectDefItem(islandCrateID, "TreeAraucania", 5, 3);
	...
	{
		int NorthIsland1 = -1;
		NorthIsland1 = rmCreateArea("north island1");
		rmSetAreaLocation(NorthIsland1, 0.9, 0.5);
		rmSetAreaSize(NorthIsland1, 0.011, 0.011); // 0.38 0.47
		rmSetAreaSmoothDistance(NorthIsland1, 3);
		rmSetAreaMix(NorthIsland1, "araucania_north_grass_b");
		rmSetAreaElevationType(NorthIsland1, cElevTurbulence);
		rmSetAreaElevationVariation(NorthIsland1, 2.0);
		...
		int NorthIsland2 = -1;
		NorthIsland2 = rmCreateArea("north island2");
		rmSetAreaLocation(NorthIsland2, 0.9, 0.5);
		rmSetAreaSize(NorthIsland2, 0.011, 0.011); // 0.38 0.47
		rmSetAreaSmoothDistance(NorthIsland2, 3);
		rmSetAreaMix(NorthIsland2, "araucania_north_grass_b");
		rmSetAreaElevationType(NorthIsland2, cElevTurbulence);
		rmSetAreaElevationVariation(NorthIsland2, 2.0);
	...
	int avoidCliff = rmCreateAreaDistanceConstraint("avoid cliff north", cliffID, 5.0);
	...
	rmAddTradeRouteWaypoint(tradeRouteID1, 0.59, 0.0);
	...
	vector socketLoc = rmGetTradeRouteWayPoint(tradeRouteID1, 0.1);
	rmPlaceObjectDefAtPoint(socketID1, 0, socketLoc);
	socketLoc = rmGetTradeRouteWayPoint(tradeRouteID1, 0.5);
	rmPlaceObjectDefAtPoint(socketID1, 0, socketLoc);
	socketLoc = rmGetTradeRouteWayPoint(tradeRouteID1, 0.90);
	rmPlaceObjectDefAtPoint(socketID1, 0, socketLoc);
	...
	{ //1v1
		rmSetRandomSpawn1v1(0.2, 0.78, 0.2, 0.22);
	}
	else if (rmGetPlayerTeam(2) != rmGetPlayerTeam(3))
	{ // 2v2
		rmSetRandomSpawn2v2(0.18, 0.78, 0.4, 0.78, 0.18, 0.22, 0.4, 0.22);
	}
	else if (rmGetPlayerTeam(3) != rmGetPlayerTeam(4))
	{ // 3v3
		rmSetRandomSpawn3v3(0.2, 0.78, 0.35, 0.78, 0.53, 0.78, 0.2, 0.22, 0.35, 0.22, 0.53, 0.22);
	}
	...
	for (i = 1; < numPlayer)
	{
		...
		rmSetAreaMix(id1, "geometricpatterngrass");
	...
	rmAddObjectDefItem(startingTrees, "TreeAraucania", 3, 8.0);
	...
	rmAddObjectDefItem(startingHunting, "Guanaco", rmRandInt(6, 7), 6.0);
	rmSetObjectDefMinDistance(startingHunting, 14.0);
	rmSetObjectDefMaxDistance(startingHunting, 15.0);
	...
	rmSetObjectDefMaxDistance(colonyShipID, rmXFractionToMeters(0.57));
	...
	rmAddObjectDefItem(StartBerriesID, "berrybush", 1, 3.0);
	...
	rmSetObjectDefMaxDistance(silverID, 5);

	int avoidHunt = rmCreateTypeDistanceConstraint("avoid the hunt1", huntType, 50.0);
	int avoidMines = rmCreateTypeDistanceConstraint("avoid the mines", "gold", 55.0);

	int herdID = rmCreateObjectDef("herd herd");
	rmAddObjectDefItem(herdID, huntType, rmRandInt(12, 13), 6.0);
	rmSetObjectDefMinDistance(herdID, 0.0);
	rmSetObjectDefMaxDistance(herdID, 2.0);
	...
	if (PlayerNum == 2)
	{
		rmPlaceObjectDefAtLoc(silverID, 0, 0.12, 0.92); // top corner
		rmPlaceObjectDefAtLoc(silverID, 0, 0.12, 0.08);
		rmPlaceObjectDefAtLoc(herdID, 0, 0.07, 0.15, 1);
		rmPlaceObjectDefAtLoc(herdID, 0, 0.07, 0.85, 1);
		...
		if (rmRandFloat() > 0.5)
		{
			...
			rmPlaceObjectDefAtLoc(herdID, 0, 0.38, 0.08);
			rmPlaceObjectDefAtLoc(herdID, 0, 0.38, 0.92);

			rmPlaceObjectDefAtLoc(herdID, 0, 0.48, 0.3, 1);
			rmPlaceObjectDefAtLoc(herdID, 0, 0.48, 0.7, 1);

			rmPlaceObjectDefAtLoc(herdID, 0, 0.65, 0.3, 1);
			rmPlaceObjectDefAtLoc(herdID, 0, 0.65, 0.7, 1);
		}
		else
		{
			...
			rmPlaceObjectDefAtLoc(silverID, 0, 0.17, 0.6);
			rmPlaceObjectDefAtLoc(silverID, 0, 0.17, 0.4);
			...
			rmPlaceObjectDefAtLoc(herdID, 0, 0.65, 0.05, 1);
			rmPlaceObjectDefAtLoc(herdID, 0, 0.65, 0.95, 1);

			rmPlaceObjectDefAtLoc(herdID, 0, 0.65, 0.05, 1);
			rmPlaceObjectDefAtLoc(herdID, 0, 0.65, 0.95, 1);

			rmPlaceObjectDefAtLoc(herdID, 0, 0.35, 0.3);
			rmPlaceObjectDefAtLoc(herdID, 0, 0.35, 0.7, 1);
	...
	{
		int staySouth = rmCreatePieConstraint("Stay South", 0.47, 0.47, rmXFractionToMeters(0.0), rmXFractionToMeters(0.5), rmDegreesToRadians(92), rmDegreesToRadians(268));
		int stayNorth = rmCreatePieConstraint("Stay North", 0.53, 0.53, rmXFractionToMeters(0.0), rmXFractionToMeters(0.5), rmDegreesToRadians(272), rmDegreesToRadians(88));
		...
		for (i = 0; < PlayerNum / 2 * 4)
		{
			...
			rmAddObjectDefItem(herdID1, huntType, rmRandInt(12, 13), 6.0);
			rmSetObjectDefMinDistance(herdID1, 0.0);
		...
		for (i = 0; < PlayerNum / 2 * 4)
		{
			...
			rmAddObjectDefItem(herdID2, huntType, rmRandInt(12, 13), 6.0);
			rmSetObjectDefMinDistance(herdID2, 0.0);
	...
	int forestPass = 8 * numPlayer;
	int forestFailCount = 0;
	for (i = 0; < forestPass)
	{
		int forestNorth = rmCreateArea("Forest north " + i, terrainMix2);
		rmSetAreaSize(forestNorth, rmAreaTilesToFraction(100), rmAreaTilesToFraction(150));
	...
	forestPass = 8 * numPlayer;
	forestFailCount = 0;
	for (i = 0; < forestPass)
	{
		int coastalForest = rmCreateArea("Coastl forest " + i);
		...
		rmAddAreaConstraint(coastalForest, avoidAll);
	...
	int whaleVsWhale = rmCreateTypeDistanceConstraint("whale v whale", "humpbackWhale", 40.0);
	...
	rmAddObjectDefConstraint(nuggetID, avoidTownCenter1);
	...
	if (isObserverMode == true)
	{
		...
		{
			if (rmGetPlayerCiv(cNumNonObsPlayers + 1) == 8)
			{
				cAllowViewLock = 1;
			}
		}
		...
		if (true)
		{
			...
			float fakeP1X_Loc = unscaledXLoc(fakeP1);
			float fakeP1Z_Loc = unscaledZLoc(fakeP1);

			float fakeP2X_Loc = unscaledXLoc(fakeP2);
			float fakeP2Z_Loc = unscaledZLoc(fakeP2);

			float fakeP3X_Loc = unscaledXLoc(fakeP3);
			float fakeP3Z_Loc = unscaledZLoc(fakeP3);

			float fakeP4X_Loc = unscaledXLoc(fakeP4);
			float fakeP4Z_Loc = unscaledZLoc(fakeP4);

			float fakeP5X_Loc = unscaledXLoc(fakeP5);
			float fakeP5Z_Loc = unscaledZLoc(fakeP5);

			float fakeP6X_Loc = unscaledXLoc(fakeP6);
			float fakeP6Z_Loc = unscaledZLoc(fakeP6);

			//Possible to streamline this??
			if (cNumNonObsPlayers == 2)
			{
				if (fakeP1X_Loc <= fakeP2X_Loc)
				{
					RealP1FromWest = fakeP1;
					RealP2FromWest = fakeP2;
				}
				else
				{
					RealP1FromWest = fakeP2;
					RealP2FromWest = fakeP1;
				}
				if (fakeP1Z_Loc >= fakeP2Z_Loc)
				{
					RealP1FromNorth = fakeP1;
					RealP2FromNorth = fakeP2;
				}
				else
				{
					RealP1FromNorth = fakeP2;
					RealP2FromNorth = fakeP1;
				}
			}
			else if (cNumNonObsPlayers == 4)
			{
				...
				if (T1MinX_Loc <= T2MinX_Loc)
				{
					...
					if (fakeP3X_Loc <= fakeP4X_Loc)
					{
						RealP3FromWest = fakeP3;
						RealP4FromWest = fakeP4;
					}
					else
					{
						RealP3FromWest = fakeP4;
						RealP4FromWest = fakeP3;
					}
				}
				else
				{
					if (fakeP3X_Loc <= fakeP4X_Loc)
					{
						RealP1FromWest = fakeP3;
						RealP2FromWest = fakeP4;
					}
					else
					{
						RealP1FromWest = fakeP4;
						RealP2FromWest = fakeP3;
					}
					if (fakeP1X_Loc <= fakeP2X_Loc)
					{
						RealP3FromWest = fakeP1;
						RealP4FromWest = fakeP2;
					}
					else
					{
						RealP3FromWest = fakeP2;
						RealP4FromWest = fakeP1;
					}
				}
				...
				if (T1MinX_Loc <= T2MinX_Loc)
				{
					...
					if (fakeP3Z_Loc >= fakeP4Z_Loc)
					{
						RealP3FromNorth = fakeP3;
						RealP4FromNorth = fakeP4;
					}
					else
					{
						RealP3FromNorth = fakeP4;
						RealP4FromNorth = fakeP3;
					}
				}
				else
				{
					if (fakeP3Z_Loc >= fakeP4Z_Loc)
					{
						RealP1FromNorth = fakeP3;
						RealP2FromNorth = fakeP4;
					}
					else
					{
						RealP1FromNorth = fakeP4;
						RealP2FromNorth = fakeP3;
					}
					if (fakeP1Z_Loc >= fakeP2Z_Loc)
					{
						RealP3FromNorth = fakeP1;
						RealP4FromNorth = fakeP2;
					}
					else
					{
						RealP3FromNorth = fakeP2;
						RealP4FromNorth = fakeP1;
					}
				}
			}
			else if (cNumNonObsPlayers == 6)
			{
				...
				if ((fakeP1Z_Loc >= fakeP2Z_Loc) && (fakeP2Z_Loc >= fakeP3Z_Loc))
				{
					RealP1FromNorth = fakeP1;
					RealP2FromNorth = fakeP2;
					RealP3FromNorth = fakeP3;
				}
				else if ((fakeP1Z_Loc >= fakeP3Z_Loc) && (fakeP3Z_Loc >= fakeP2Z_Loc))
				{
					RealP1FromNorth = fakeP1;
					RealP2FromNorth = fakeP3;
					RealP3FromNorth = fakeP2;
				}
				else if ((fakeP2Z_Loc >= fakeP1Z_Loc) && (fakeP1Z_Loc >= fakeP3Z_Loc))
				{
					RealP1FromNorth = fakeP2;
					RealP2FromNorth = fakeP1;
					RealP3FromNorth = fakeP3;
				}
				else if ((fakeP2Z_Loc >= fakeP3Z_Loc) && (fakeP3Z_Loc >= fakeP1Z_Loc))
				{
					RealP1FromNorth = fakeP2;
					RealP2FromNorth = fakeP3;
					RealP3FromNorth = fakeP1;
				}
				else if ((fakeP3Z_Loc >= fakeP2Z_Loc) && (fakeP2Z_Loc >= fakeP1Z_Loc))
				{
					RealP1FromNorth = fakeP3;
					RealP2FromNorth = fakeP2;
					RealP3FromNorth = fakeP1;
				...
				if ((fakeP4Z_Loc >= fakeP5Z_Loc) && (fakeP5Z_Loc >= fakeP6Z_Loc))
				{
					RealP4FromNorth = fakeP4;
					RealP5FromNorth = fakeP5;
					RealP6FromNorth = fakeP6;
				}
				else if ((fakeP4Z_Loc >= fakeP6Z_Loc) && (fakeP6Z_Loc >= fakeP5Z_Loc))
				{
					RealP4FromNorth = fakeP4;
					RealP5FromNorth = fakeP6;
					RealP6FromNorth = fakeP5;
				}
				else if ((fakeP5Z_Loc >= fakeP4Z_Loc) && (fakeP4Z_Loc >= fakeP6Z_Loc))
				{
					RealP4FromNorth = fakeP5;
					RealP5FromNorth = fakeP4;
					RealP6FromNorth = fakeP6;
				}
				else if ((fakeP5Z_Loc >= fakeP6Z_Loc) && (fakeP6Z_Loc >= fakeP4Z_Loc))
				{
					RealP4FromNorth = fakeP5;
					RealP5FromNorth = fakeP6;
					RealP6FromNorth = fakeP4;
				}
				else if ((fakeP6Z_Loc >= fakeP5Z_Loc) && (fakeP5Z_Loc >= fakeP4Z_Loc))
				{
					RealP4FromNorth = fakeP6;
					RealP5FromNorth = fakeP5;
					RealP6FromNorth = fakeP4;
				}
				else
				...
				if ((fakeP1X_Loc <= fakeP2X_Loc) && (fakeP2X_Loc <= fakeP3X_Loc))
				{
					RealP1FromWest = fakeP1;
					RealP2FromWest = fakeP2;
					RealP3FromWest = fakeP3;
				}
				else if ((fakeP1X_Loc <= fakeP3X_Loc) && (fakeP3X_Loc <= fakeP2X_Loc))
				{
					RealP1FromWest = fakeP1;
					RealP2FromWest = fakeP3;
					RealP3FromWest = fakeP2;
				}
				else if ((fakeP2X_Loc <= fakeP1X_Loc) && (fakeP1X_Loc <= fakeP3X_Loc))
				{
					RealP1FromWest = fakeP2;
					RealP2FromWest = fakeP1;
					RealP3FromWest = fakeP3;
				}
				else if ((fakeP2X_Loc <= fakeP3X_Loc) && (fakeP3X_Loc <= fakeP1X_Loc))
				{
					RealP1FromWest = fakeP2;
					RealP2FromWest = fakeP3;
					RealP3FromWest = fakeP1;
				}
				else if ((fakeP3X_Loc <= fakeP2X_Loc) && (fakeP2X_Loc <= fakeP1X_Loc))
				{
					RealP1FromWest = fakeP3;
					RealP2FromWest = fakeP2;
					RealP3FromWest = fakeP1;
				...
				if ((fakeP4X_Loc <= fakeP5X_Loc) && (fakeP5X_Loc <= fakeP6X_Loc))
				{
					RealP4FromWest = fakeP4;
					RealP5FromWest = fakeP5;
					RealP6FromWest = fakeP6;
				}
				else if ((fakeP4X_Loc <= fakeP6X_Loc) && (fakeP6X_Loc <= fakeP5X_Loc))
				{
					RealP4FromWest = fakeP4;
					RealP5FromWest = fakeP6;
					RealP6FromWest = fakeP5;
				}
				else if ((fakeP5X_Loc <= fakeP4X_Loc) && (fakeP4X_Loc <= fakeP6X_Loc))
				{
					RealP4FromWest = fakeP5;
					RealP5FromWest = fakeP4;
					RealP6FromWest = fakeP6;
				}
				else if ((fakeP5X_Loc <= fakeP6X_Loc) && (fakeP6X_Loc <= fakeP4X_Loc))
				{
					RealP4FromWest = fakeP5;
					RealP5FromWest = fakeP6;
					RealP6FromWest = fakeP4;
				}
				else if ((fakeP6X_Loc <= fakeP5X_Loc) && (fakeP5X_Loc <= fakeP4X_Loc))
				{
					RealP4FromWest = fakeP6;
					RealP5FromWest = fakeP5;
					RealP6FromWest = fakeP4;
				}
				else
				...
				if (getMax(getMax(fakeP1X_Loc, fakeP2X_Loc), fakeP3X_Loc) > getMax(getMax(fakeP4X_Loc, fakeP5X_Loc), fakeP6X_Loc))
				{
					...
					fakeTemp = RealP1FromWest;
					RealP1FromWest = RealP4FromWest;
					RealP4FromWest = fakeTemp;
					fakeTemp = RealP2FromWest;
					RealP2FromWest = RealP5FromWest;
					RealP5FromWest = fakeTemp;
					fakeTemp = RealP3FromWest;
					RealP3FromWest = RealP6FromWest;
					RealP6FromWest = fakeTemp;

					fakeTemp = RealP1FromNorth;
					RealP1FromNorth = RealP4FromNorth;
					RealP4FromNorth = fakeTemp;
					fakeTemp = RealP2FromNorth;
					RealP2FromNorth = RealP5FromNorth;
					RealP5FromNorth = fakeTemp;
					fakeTemp = RealP3FromNorth;
					RealP3FromNorth = RealP6FromNorth;
					RealP6FromNorth = fakeTemp;
				}
...
*/
		...
		for (i = 0; < numconfigvariables)
		{
			cEf(" if(CCV==" + i + "){" + configVar(i) + "=" + configVar(i) + "+DCV;} ");
		}
		cEf(" } ");
		...
		for (i = 0; < numconfigvariables)
		{
			cEf(" kat(\"" + configVar(i) + "=\"+" + configVar(i) + "); ");
		}
		cEf(" } ");
		...
		for (i = 0; <= 9)
		{
			cEf(" trEventSetHandler(5800" + i + ",\"SetAdjustConfig" + i + "\"); ");
		}
		for (i = 10; < numconfigvariables)
		{
			cEf(" trEventSetHandler(580" + i + ",\"SetAdjustConfig" + i + "\"); ");
		}
		...
		for (p = 1; <= cNumNonObsPlayers)
		{
			if (rmGetPlayerTeam(p) == rmGetPlayerTeam(1))
			{
				cEf(" xsArraySetInt(PlTM," + p + ",1); ");
			}
			else
			{
				cEf(" xsArraySetInt(PlTM," + p + ",2); ");
			}
		}
		for (p = (cNumNonObsPlayers + 1); <= cNumberNonGaiaPlayers)
		{
		...
		cEf(" if(new==452 && old==272){return(1);} ");
		cEf(" if(new==452 && old==331){return(1);} ");
		cEf(" if(new==453 && old==339){return(1);} ");
		cEf(" if(new==453 && old==343){return(1);} ");
		cEf(" if(new==454 && old==347){return(1);} ");
		cEf(" if(new==454 && old==270){return(1);} ");
		cEf(" if(new==455 && old==275){return(1);} ");
		cEf(" if(new==455 && old==345){return(1);} ");
		cEf(" if(new==456 && old==340){return(1);} ");
		cEf(" if(new==456 && old==268){return(1);} ");
		cEf(" if(new==457 && old==263){return(1);} ");
		cEf(" if(new==457 && old==325){return(1);} ");
		cEf(" if(new==458 && old==304){return(1);} ");
		cEf(" if(new==459 && old==271){return(1);} ");
		cEf(" if(new==459 && old==354){return(1);} ");
		cEf(" if(new==460 && old==273){return(1);} ");
		cEf(" if(new==460 && old==303){return(1);} ");
		...
		cEf(" if(new==466 && old==267){return(1);} ");
		cEf(" if(new==466 && old==401){return(1);} ");
		cEf(" if(new==467 && old==273){return(1);} ");
		cEf(" if(new==468 && old==270){return(1);} ");
		cEf(" if(new==468 && old==333){return(1);} ");
		cEf(" if(new==469 && old==263){return(1);} ");
		cEf(" if(new==469 && old==413){return(1);} ");
		cEf(" if(new==470 && old==272){return(1);} ");
		cEf(" if(new==470 && old==355){return(1);} ");
		...
		cEf(" if(new==1001 && old==273){return(1);} ");
		cEf(" if(new==1001 && old==332){return(1);} ");
...
*/
	...
	cEf(" } "); */
		...
		if (cNumNonObsPlayers > 2)
		{
			cEf(" gadgetReal(\"Spec_Flag_1_0\");gadgetReal(\"Spec_Flag_4_0\"); ");
		}
		if (cNumNonObsPlayers > 4)
		{
			cEf(" gadgetReal(\"Spec_Flag_0_0\");gadgetReal(\"Spec_Flag_5_0\"); ");
		}
		cEf(" } ");
		cEf(" trUnitSelectClear(); ");
		cEf(" for(m=" + rmGetUnitPlaced(BCOSIMBATMAN, 0) + ";<=" + rmGetUnitPlaced(BCOSIMBATMAN, rmGetNumberUnitsPlaced(BCOSIMBATMAN) - 1) + "){ ");
		...
		for (p = 1; <= cNumNonObsPlayers)
		{
			...
			{
				if (rPFromWest(flagposition) == p)
				{
					cEf(" trOverlayText(echoOutput,1,flag" + (flagposition + (2 - cNumNonObsPlayers / 2)) + "Xpos-flagXleeway,60,59+2*flagXleeway,\"\"); ");
...
*/
		...
		if (true)
		{
			...
			if (true)
			{
				...
				xpPC(7729, 6526, 1203);
				xpPC(9113, 7729, 1384);
				xpPC(10706, 9113, 1593);
				xpPC(12536, 10706, 1830);
				xpPC(14642, 12536, 2106);
				xpPC(17064, 14642, 2422);
				xpPC(19563, 17064, 2499);
				...
				xpPC(8035, 6700, 1335);
				xpPC(9571, 8035, 1536);
				xpPC(11336, 9571, 1765);
				xpPC(13367, 11336, 2031);
				xpPC(15701, 13367, 2334);
				xpPC(18202, 15701, 2501);
				...
				xpPC(7570, 6269, 1301);
				xpPC(9064, 7570, 1494);
				xpPC(10784, 9064, 1720);
				xpPC(12762, 10784, 1978);
				xpPC(15035, 12762, 2273);
				xpPC(17535, 15035, 2500);
				...
				xpPC(7889, 6578, 1311);
				xpPC(9397, 7889, 1508);
				xpPC(11130, 9397, 1733);
				xpPC(13123, 11130, 1993);
				xpPC(15416, 13123, 2293);
				xpPC(17916, 15416, 2500);
				...
				xpPC(7304, 6091, 1213);
				xpPC(8701, 7304, 1397);
				xpPC(10305, 8701, 1604);
				xpPC(12152, 10305, 1847);
				xpPC(14274, 12152, 2122);
				xpPC(16716, 14274, 2442);
				xpPC(19215, 16716, 2499);
			...
			for (r = 0; < 3)
			{
				...
				for (p = 1; <= cNumNonObsPlayers)
				{
					cEf(" if(plyr==" + p + "){result=Del" + resName(r) + "_" + p + "; return(result);} ");
				}
				cEf(" return(result); ");
				cEf(" } ");
			}
			...
			for (p = 1; <= cNumNonObsPlayers)
			{
				cEf(" if(plyr==" + p + "){result=DelTrade_" + p + "; return(result);} ");
			}
			cEf(" return(result); ");
			cEf(" } ");
			...
			for (r = 0; < 4)
			{
				...
				for (p = 1; <= cNumNonObsPlayers)
				{
					cEf(" if(plyr==" + p + "){return(PopGathr" + resName(r) + "_" + p + ");} ");
				}
				cEf(" return(0); ");
				cEf(" } ");
			}
			...
			for (r = -1; < 3)
			{
				...
				for (p = 1; <= cNumNonObsPlayers)
				{
					cEf(" if(plyr==" + p + "){return(DeadCost" + resName(r) + "_" + p + ");} ");
				}
				cEf(" return(0); ");
				cEf(" } ");
			}
			...
			if (cTeamSize == 1)
			{
				...
				for (p = 1; <= cNumNonObsPlayers)
				{
					...
					if (p == 1)
					{
						cEf(" output=output+\"<icon=(3)(effects\impacts\4by4whitesquare)(0)>\"; ");
					}
				}
		...
		for (t = 0; <= 10)
		{
			...
			if (cNumNonObsPlayers > 2)
			{
				cEf(" scrollingindex3=-1;scrollingindex4=-1; ");
			}
			if (cNumNonObsPlayers > 4)
			{
				cEf(" scrollingindex5=-1;scrollingindex6=-1; ");
			}
			if (cNumNonObsPlayers > 2)
			{
...
*/
		...
		if (cNumNonObsPlayers == 4)
		{
			cEf(" gadgetUnreal(\"Spec_RightOptionsLabel\");gadgetUnreal(\"Spec_RightOptions\"); ");
		}
		if (cNumNonObsPlayers == 6)
		{
			cEf(" gadgetUnreal(\"Spec_RightOptionsLabel3v3\");gadgetUnreal(\"Spec_RightOptions3v3\"); ");
		}
		cEf(" gadgetUnreal(\"uimain-Score-SpecContainer\"); gadgetUnreal(\"victoryDisplay\"); ");
		cEf(" gadgetUnreal(\"unitselectionpanel-SpecContainer\"); ");
		cEf(" gadgetUnreal(\"SettlerCountDialog-advancedPanelNatMin-SpecContainer\"); ");
		...
		for (f = 1; <= cNumNonObsPlayers)
		{
			if (f <= cNumNonObsPlayers / 2)
			{
				cEf(" tempmaxtL=strmax(tempmaxtL,kbGetPlayerName(" + rPFromWest(f) + ")); ");
			}
			else
			{
				cEf(" tempmaxtR=strmax(tempmaxtR,kbGetPlayerName(" + rPFromWest(f) + ")); ");
			}
		}
		...
		if (cTeamSize == 1)
		{
			cEf(" gadgetReal(\"RTD-1v1ScrollButtons\"); ");
		}
		else if (cTeamSize == 2)
		{
			cEf(" gadgetReal(\"RTD-2v2ScrollButtons\"); ");
		}
		else if (cTeamSize == 3)
		{
			cEf(" gadgetReal(\"RTD-2v2ScrollButtons\");gadgetReal(\"RTD-3v3ScrollButtons\"); ");
		}
		...
		if (IDesignRMS == 1)
		{
			cEf(" kat(\"Filename: " + cFilename + "\");kat(\"TTT: " + cNumAllTechs + "\");echoSTARTLOCS(); ");
		}
