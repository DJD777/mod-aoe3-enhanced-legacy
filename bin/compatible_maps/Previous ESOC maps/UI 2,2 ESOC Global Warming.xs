// ESOC Global Warming, based on ESOC INDONESIA (1V1, TEAM, FFA)
// ESOC INDONESIA designed by Garja
// Global Warming edits by EAGLEMUT
...
//	rmSetMapElevationHeightBlend(1);
	...
	int avoidEleShort = rmCreateTypeDistanceConstraint("avoid  Ele short", "ypWildElephant", 25.0);
	...
	int avoidGold = rmCreateClassDistanceConstraint ("gold avoid gold med", rmClassID("Gold"), 58.0-1*PlayerNum);
	int avoidGoldFar = rmCreateClassDistanceConstraint ("gold avoid gold far", rmClassID("Gold"), 68.0-1*PlayerNum);
	...
	int avoidTownCenterVeryFar = rmCreateTypeDistanceConstraint("avoid Town Center Very Far", "townCenter", 70.0-1*PlayerNum);
	...
	if (isObserverMode == true)
	{
		...
		{ //1v1
			if (playerplacement == 1)
				rmSetRandomSpawn1v1(0.28,0.52,  0.72,0.48);
			else
				rmSetRandomSpawn1v1(0.48,0.72,  0.52,0.28);
		}
		else if (rmGetPlayerTeam(2)!=rmGetPlayerTeam(3))
		{ // 2v2
			rmSetRandomSpawn2v2(0.28,0.64,  0.28,0.48,  0.72,0.52,  0.72,0.36);
		}
		else if (rmGetPlayerTeam(3)!=rmGetPlayerTeam(4))
		{ // 3v3
			rmSetRandomSpawn3v3(0.28,0.68,  0.28,0.56,  0.28,0.44,  0.72,0.56,  0.72,0.44,  0.72,0.32);
		}
	}
	else
	{
...
//	rmAddAreaTerrainLayer(bay2ID, "borneo\ground_sand1_borneo", 0, 3);
	...
	rmSetAreaMix(mainislandID, "borneo_grass_a");
	rmSetAreaTerrainType(mainislandID, "borneo\ground_forest_borneo");
	rmAddAreaTerrainLayer(mainislandID, "borneo\ground_sand1_borneo", 0, 2);
	rmAddAreaTerrainLayer(mainislandID, "borneo\ground_sand2_borneo", 2, 4);
	rmAddAreaTerrainLayer(mainislandID, "borneo\ground_sand3_borneo", 4, 6);
	rmAddAreaTerrainLayer(mainislandID, "borneo\ground_grass4_borneo", 6, 8);
	rmAddAreaTerrainLayer(mainislandID, "borneo\ground_grass3_borneo", 8, 10);
	rmAddAreaTerrainLayer(mainislandID, "borneo\ground_grass2_borneo", 10, 12);
	rmAddAreaTerrainLayer(mainislandID, "borneo\ground_grass1_borneo", 12, 14);
...
//	rmSetAreaTerrainType(playerareaID, "new_england\ground2_cliff_ne"); // for testing
	...
	for (i=0; < 3)
	{
		...
		else if (i==1)
		{
			...
			rmSetAreaCliffType(hillAID, "araucania central"); 
		//	rmSetAreaTerrainType(hillAID, "borneo\ground_grass1_borneo");	
			rmSetAreaCliffPainting(hillAID, false, true, true, 0.5 , true); //  paintGround,  paintOutsideEdge,  paintSide,  minSideHeight,  paintInsideEdge
	...
	//		rmSetAreaCliffPainting(hillAID, false, true, true, 0.5 , true); //  paintGround,  paintOutsideEdge,  paintSide,  minSideHeight,  paintInsideEdge
		...
		*/
		...
		for (j=0; < 600)
		{
			...
			rmAddObjectDefItem(RiceAID, "PropGrassShort", rmRandInt(1,1), 1.0); 
	...
	for (i=0; < 3)
	{
		...
		else if(i == 1)
		{
			...
			rmSetAreaCliffType(hillBID, "araucania central"); 
		//	rmSetAreaTerrainType(hillBID, "borneo\ground_grass1_borneo");	
			rmSetAreaCliffPainting(hillBID, false, true, true, 0.5 , true); //  paintGround,  paintOutsideEdge,  paintSide,  minSideHeight,  paintInsideEdge
		...
		else
		{
			...
			rmSetAreaCliffEdge(hillBID, 1, 1.0, 0.0, 0.0, 1); 
			rmSetAreaCliffType(hillBID, "coastal japan"); 
			rmSetAreaTerrainType(hillBID, "borneo\ground_forest_borneo");	
			rmSetAreaCliffPainting(hillBID, false, true, true, 0.5 , true); //  paintGround,  paintOutsideEdge,  paintSide,  minSideHeight,  paintInsideEdge
			rmAddAreaConstraint(hillBID, avoidImpassableLandShort);
		...
		*/
		...
		for (j=0; < 350)
		{
			...
			rmAddObjectDefItem(RiceBID, "PropGrassShort", rmRandInt(1,1), 1.0); 
	...
	rmSetAreaMix(bigislandID, "borneo_grass_a");
	rmSetAreaTerrainType(bigislandID, "borneo\ground_forest_borneo");
	rmAddAreaTerrainLayer(bigislandID, "borneo\ground_sand1_borneo", 0, 2);
	rmAddAreaTerrainLayer(bigislandID, "borneo\ground_sand2_borneo", 2, 4);
	rmAddAreaTerrainLayer(bigislandID, "borneo\ground_sand3_borneo", 4, 6);
	rmAddAreaTerrainLayer(bigislandID, "borneo\ground_grass4_borneo", 6, 8);
	rmAddAreaTerrainLayer(bigislandID, "borneo\ground_grass3_borneo", 8, 10);
	rmAddAreaTerrainLayer(bigislandID, "borneo\ground_grass2_borneo", 10, 12);
	rmAddAreaTerrainLayer(bigislandID, "borneo\ground_grass1_borneo", 12, 14);
	...
	rmSetAreaMix(smallislandID, "borneo_grass_a");
	rmSetAreaTerrainType(smallislandID, "borneo\ground_forest_borneo");
	rmAddAreaTerrainLayer(smallislandID, "borneo\ground_sand1_borneo", 0, 2);
	rmAddAreaTerrainLayer(smallislandID, "borneo\ground_sand2_borneo", 2, 4);
	rmAddAreaTerrainLayer(smallislandID, "borneo\ground_sand3_borneo", 4, 6);
	rmAddAreaTerrainLayer(smallislandID, "borneo\ground_grass4_borneo", 6, 8);
	rmAddAreaTerrainLayer(smallislandID, "borneo\ground_grass3_borneo", 8, 10);
	rmAddAreaTerrainLayer(smallislandID, "borneo\ground_grass2_borneo", 10, 12);
	rmAddAreaTerrainLayer(smallislandID, "borneo\ground_grass1_borneo", 12, 14);
...
//	rmSetAreaTerrainType(natAreaB, "new_england\ground2_cliff_ne");
	...
	int nativeID3 = -1;
		...
		nativeID2 = rmCreateGrouping("Sufi mosque A", "native sufi mosque borneo "+3);
		nativeID3 = rmCreateGrouping("Sufi mosque B", "native sufi mosque borneo "+3);
...
//	rmAddObjectDefConstraint(playergoldID, avoidEdge);
	...
	rmAddObjectDefItem(playerTreeID, "ypTreeBorneoPalm", rmRandInt(10,10), 7.0);
...
//	rmAddObjectDefConstraint(playeherdID, avoidImpassableLand);
	...
	rmAddObjectDefConstraint(player2ndherdID, avoidSerowShort);
...
//	rmAddObjectDefConstraint(player2ndherdID, avoidImpassableLand);
	...
	// 3rd herd
	int player3rdherdID = rmCreateObjectDef("player 3nd herd");
	rmAddObjectDefItem(player3rdherdID, "ypserow", rmRandInt(8,8), 6.0);
    rmSetObjectDefMinDistance(player3rdherdID, 38);
    rmSetObjectDefMaxDistance(player3rdherdID, 40);
	...
	rmAddObjectDefConstraint(player3rdherdID, avoidSerowShort);
...
//	rmAddObjectDefConstraint(player3rdherdID, avoidImpassableLand);
	...
	rmAddObjectDefConstraint(player3rdherdID, avoidNativesShort);
...
//			rmPlaceObjectDefAtLoc(playerNuggetID, i, rmXMetersToFraction(xsVectorGetX(TCLoc)), rmZMetersToFraction(xsVectorGetZ(TCLoc)));		
	...
	int goldcount = 1+0.5*PlayerNum;  
	
	int coppercount = 2+1*PlayerNum;
...
//		rmAddObjectDefConstraint(commoncopperID, avoidTradeRouteSocket);
	...
	// Inland forest
	int forestinlandcount = 4+2*PlayerNum; //12
	...
	for (i=0; < forestinlandcount)
	{
		...
		rmSetAreaTerrainType(forestinlandID, "borneo\ground_forest_borneo"); 
...
//		rmAddAreaConstraint(forestinlandID, avoidEdge);
		...
		for (j=0; < rmRandInt(18,22))
		{
			...
			rmAddObjectDefItem(forestinlandtreeID, "ypTreeBorneo", rmRandInt(1,2), 3.0);
...
//			rmAddObjectDefConstraint(forestinlandtreeID, avoidImpassableLandShort);
	...
	// Central forest
	int forestcentralcount = 2+1*PlayerNum; //4
	...
	for (i=0; < forestcentralcount)
	{
		...
		rmSetAreaTerrainType(forestcentralID, "borneo\ground_forest_borneo"); 
...
//		rmAddAreaConstraint(forestcentralID, avoidCliff);
		...
		for (j=0; < rmRandInt(16,18))
		{
			...
			rmAddObjectDefItem(forestcentraltreeID, "ypTreeBorneo", rmRandInt(1,2), 3.0);
...
//			rmAddObjectDefConstraint(forestcentraltreeID, avoidImpassableLandShort);
	...
	// Coastal forest
	int forestcoastalcount = 4+2*PlayerNum; //12
...
//		rmSetAreaTerrainType(forestcoastalID, "borneo\ground_forest_borneo"); 
...
//		rmAddAreaConstraint(forestcoastalID, avoidEdge);
		...
		for (j=0; < rmRandInt(14,16))
		{
			...
			rmAddObjectDefItem(forestcoastaltreeID, "ypTreeBorneoPalm", rmRandInt(1,2), 3.0);
...
//			rmAddObjectDefConstraint(forestcoastaltreeID, avoidImpassableLandShort);
	...
	// Random  trees 
	for (i=0; < 8+2*PlayerNum)
	{
		int randominlandtreeID = rmCreateObjectDef("random trees inland "+i);
		if (i < 8)
			rmAddObjectDefItem(randominlandtreeID, "ypTreeBorneo", rmRandInt(2,3), 5.0);
		else
			rmAddObjectDefItem(randominlandtreeID, "ypTreeBorneoPalm", rmRandInt(2,3), 5.0);
...
//		rmAddObjectDefConstraint(randominlandtreeID, avoidTradeRouteSocket);
	...
	// Middle  trees 
	for (i=0; < 2+1*PlayerNum)
	{
		int middletreeID = rmCreateObjectDef("middle trees "+i);
		rmAddObjectDefItem(middletreeID, "ypTreeBorneo", rmRandInt(5,8), 8.0);
	...
	int serowherdcount = 4+2*PlayerNum;
...
//		rmAddObjectDefConstraint(serowherdID, avoidTradeRouteSocket);
	...
	int berriescount = 4+2*PlayerNum;
...
//		rmAddObjectDefConstraint(berriesID, avoidTradeRouteSocket);
	...
	int treasure4count = 1+0.34*PlayerNum;
...
//		rmAddObjectDefConstraint(BuffaloID, avoidTradeRouteSocket);
	...
	// ************ Sea resources *************
	 ...
	 // Water nuggets
	int nuggetwcount = 4+1*PlayerNum;
	...
	//Fish
	int fishcount = 12+4*PlayerNum;
	int whalecount = 6+2*PlayerNum;
