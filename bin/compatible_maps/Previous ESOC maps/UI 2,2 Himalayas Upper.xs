...
void main(void)
{
  ...
  rmSetStatusText("",0.20);
	...
	if (isObserverMode == true) {
		...
		if (rmGetPlayerTeam(1)!=rmGetPlayerTeam(2)){ //1v1
			rmSetRandomSpawn1v1(0.8000,0.77,  0.2000,0.23);
		}
		else if (rmGetPlayerTeam(2)!=rmGetPlayerTeam(3)){ // 2v2
			rmSetRandomSpawn2v2(0.8000,0.7499,  0.8000,0.2500,  0.2000,0.2503,  0.2000,0.7500);
		}
		else if (rmGetPlayerTeam(3)!=rmGetPlayerTeam(4)){ // 3v3
			rmSetRandomSpawn3v3(0.2000,0.7500,  0.2000,0.2501,  0.2000,0.5000,  0.8000,0.7500,  0.8000,0.5000,  0.8000,0.2500);
		}
	} else {
  ...
  rmPlaceObjectDefAtLoc(huntable1ID, 0, 0.5, 0.5, 3*PlayerNum);
  ...
  rmPlaceObjectDefAtLoc(huntable2ID, 0, 0.5, 0.5, PlayerNum*2);
  ...
  rmPlaceObjectDefAtLoc(Herdable1ID, 0, 0.5, 0.5, PlayerNum*3);
