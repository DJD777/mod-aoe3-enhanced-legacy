...
// ------------------------------------------------------ Comentaries ---------------------------------------------------------------------------
// For Treaty Patch
// Work done by Rikikipu - September 2016
// Idea: Charlemagen


// ------------------------------------------------------ Starting the OP UI --------------------------------------------------------------------

// No  UI in this version... just kidding!
...
void main(void)
{
   ...
   if (rmAllocateSubCivs(2) == true)
   {
		...
		rmEchoInfo("subCiv2 is Nootka "+subCiv2);
   }
   int numTries = -1;
   int failCount = -1;
...
// X marks the spot
   ...
   // Player constraints
   int playerConstraint=rmCreateClassDistanceConstraint("player vs. player", classPlayer, 5.0);
   ...
   // Avoid the Cliffs.
   int avoidCliffsShort = rmCreateClassDistanceConstraint("avoid Cliffs short", rmClassID("classCliff"), 1.0);
...
// ------------------------------------------------------ Trade Route ---------------------------------------------------------------------------
   ...
   rmAddObjectDefConstraint(socketID,avoidCliffsShort);
...
// ------------------------------------------------------ Player Location and Specific Area ---------------------------------------------------------------------------
	...
	if (isObserverMode == true) {
		if(PlayerNum==2)
		{
			if (rmRandFloat(0,1)<0.5)
			{
				...
				rmPlacePlayer(3, 0.6, 0.3);
				rmPlacePlayer(4, 0.3, 0.56);
			}
			else
			{
		...
		else if(PlayerNum==4)
		{
			if (rmRandFloat(0,1)<0.5)
			{
				rmPlacePlayer(1, 0.15, 0.4);
				rmPlacePlayer(2, 0.4, 0.15);
				rmPlacePlayer(3, 0.85, 0.6);
				rmPlacePlayer(4, 0.6, 0.85);
				rmPlacePlayer(5, 0.6, 0.3);
				rmPlacePlayer(6, 0.3, 0.56);
				rmPlacePlayer(7, 0.40, 0.66);
			}
			else
			{
				rmPlacePlayer(3, 0.15, 0.4);
				rmPlacePlayer(4, 0.4, 0.15);
				rmPlacePlayer(1, 0.85, 0.6);
				rmPlacePlayer(2, 0.6, 0.85);
				rmPlacePlayer(5, 0.6, 0.3);
				rmPlacePlayer(6, 0.3, 0.56);
				rmPlacePlayer(7, 0.42, 0.69);
			}
		}
		else if(PlayerNum==6)
		{
			if (rmRandFloat(0,1)<0.5)
			{
				...
				rmPlacePlayer(4, 0.85, 0.55);
				rmPlacePlayer(5, 0.75, 0.75);
				rmPlacePlayer(6, 0.55, 0.85);
				rmPlacePlayer(7, 0.6, 0.3);
				rmPlacePlayer(8, 0.3, 0.56);
			}
			else
			{
				rmPlacePlayer(4, 0.15, 0.45);
				rmPlacePlayer(5, 0.25, 0.25);
				rmPlacePlayer(6, 0.45, 0.15);
				rmPlacePlayer(1, 0.85, 0.55);
				rmPlacePlayer(2, 0.75, 0.75);
				rmPlacePlayer(3, 0.55, 0.85);
				rmPlacePlayer(7, 0.6, 0.3);
				rmPlacePlayer(8, 0.3, 0.56);
			}
		}
   ...
   rmSetAreaTerrainType(newGrass, "california\fakecalifgrassmix_cal");
   rmSetAreaMix(newGrass, "california grass");
   ...
   rmSetAreaTerrainType(newGrass2, "california\ground5_cal");
   rmSetAreaMix(newGrass2, "california grass");
   ...
   int startingTCID = rmCreateObjectDef("startingTC");
	...
	//obs tcs
	for(i=numPlayer; <=cNumberPlayers){ rmPlaceObjectDefAtLoc(startingTCID, i, rmPlayerLocXFraction(i), rmPlayerLocZFraction(i));}
   
   int littleCircleArea = rmCreateArea("new grass3"+i);
   rmSetAreaLocation(littleCircleArea, 0.5, 0.5);
   rmAddAreaInfluenceSegment(littleCircleArea, 0.55, 0.45, 0.45, 0.55);
   rmAddAreaInfluenceSegment(littleCircleArea, 0.55, 0.55, 0.45, 0.45);   
   rmSetAreaWarnFailure(littleCircleArea, false);
   rmSetAreaSize(littleCircleArea, 0.075, 0.075);
 //  rmSetAreaSize(littleCircleArea, 0.06, 0.06);
   rmSetAreaCoherence(littleCircleArea, 0.8);
   rmSetAreaSmoothDistance(littleCircleArea, 5);
   rmAddAreaToClass(littleCircleArea, rmClassID("classPatch")); 
   rmSetAreaTerrainType(littleCircleArea, "california\desert2_cal"); // to check if the area to avoid is OK
   rmAddAreaTerrainLayer(littleCircleArea,"california\desert4_cal",0,5);
   rmBuildArea(littleCircleArea);

    int BigCircleCliff = rmCreatePieConstraint("Bog Circle for cliffs",0.5,0.5, rmXFractionToMeters(0.0),rmXFractionToMeters(0.25), rmDegreesToRadians(0),rmDegreesToRadians(360));
	int LittleCircleCliff = rmCreateAreaDistanceConstraint("little Circle for cliffs", littleCircleArea, 1);
	int ForestavoidCenter = rmCreateAreaDistanceConstraint("forests avoid Center", littleCircleArea, rmXFractionToMeters(0.06));
...
//	  rmSetAreaTerrainType(cliffID, "california\groundshore4_cal");
      rmSetAreaCliffPainting(cliffID, true, true, true, 1.5, true);
      rmSetAreaCliffHeight(cliffID, 8, 0, 1);
	  ...
	  rmAddAreaConstraint(cliffID, LittleCircleCliff);
	  rmAddAreaConstraint(cliffID, BigCircleCliff);
	rmBuildArea(cliffID);

   numTries=1;
   failCount=0;

    int cliffID1=rmCreateArea("cliff1");
	rmSetAreaLocation(cliffID1, 0.65, 0.35);
	//rmAddAreaInfluenceSegment(cliffID1, 0.6, 0.4, 0.6, 0.6);
	rmSetAreaSize(cliffID1, 0.03, 0.03);
    rmSetAreaWarnFailure(cliffID1, false);
	rmSetAreaCliffType(cliffID1, "california");
    rmSetAreaCliffEdge(cliffID1, 1, 1);
//	rmSetAreaTerrainType(cliffID1, "california\groundshore4_cal");
    rmSetAreaCliffPainting(cliffID1, true, true, true, 1.5, true);
    rmSetAreaCliffHeight(cliffID1, 8, 0, 1);
    rmSetAreaHeightBlend(cliffID1, 2);
    rmAddAreaToClass(cliffID1, rmClassID("classCliff")); 
    rmSetAreaSmoothDistance(cliffID1, 0);
    rmSetAreaCoherence(cliffID1, 0.75);
	rmAddAreaConstraint(cliffID1, LittleCircleCliff);
	rmAddAreaConstraint(cliffID1, BigCircleCliff);
   ...
   {  
      ...
      NootkaVillageAID = rmCreateGrouping("nootka village A", "native nootka village "+4);
      rmSetGroupingMinDistance(NootkaVillageAID, 0.00);
      rmSetGroupingMaxDistance(NootkaVillageAID, 0.00);
      rmAddGroupingConstraint(NootkaVillageAID, avoidImpassableLand);
      rmAddGroupingToClass(NootkaVillageAID, rmClassID("natives"));
      rmPlaceGroupingAtLoc(NootkaVillageAID, 0, 0.1, 0.55);

      int NootkaVillageAID2 = -1;
      NootkaVillageAID2 = rmCreateGrouping("Nootka village B", "native nootka village "+2);
      rmSetGroupingMinDistance(NootkaVillageAID2, 0.0);
      rmSetGroupingMaxDistance(NootkaVillageAID2, 0.00);
      rmAddGroupingConstraint(NootkaVillageAID2, avoidImpassableLand);
      rmAddGroupingToClass(NootkaVillageAID2, rmClassID("natives"));
      rmPlaceGroupingAtLoc(NootkaVillageAID2, 0, 0.9, 0.45); 
	  
	  int NootkaVillageAID3 = -1;
      NootkaVillageAID3 = rmCreateGrouping("Nootka village C", "native nootka village "+1);
      rmSetGroupingMinDistance(NootkaVillageAID3, 0.0);
      rmSetGroupingMaxDistance(NootkaVillageAID3, 0.00);
      rmAddGroupingConstraint(NootkaVillageAID3, avoidImpassableLand);
      rmAddGroupingToClass(NootkaVillageAID3, rmClassID("natives"));
      rmPlaceGroupingAtLoc(NootkaVillageAID3, 0, 0.45, 0.9); 
	  
	 int NootkaVillageAID4 = -1;
      NootkaVillageAID4 = rmCreateGrouping("Nootka village D", "native nootka village "+2);
      rmSetGroupingMinDistance(NootkaVillageAID4, 0.0);
      rmSetGroupingMaxDistance(NootkaVillageAID4, 0.00);
      rmAddGroupingConstraint(NootkaVillageAID4, avoidImpassableLand);
      rmAddGroupingToClass(NootkaVillageAID4, rmClassID("natives"));
      rmPlaceGroupingAtLoc(NootkaVillageAID4, 0, 0.55, 0.1); 
   }
// ------------------------------------------------------ Starting Ressources ---------------------------------------------------------------------------
	...
	rmAddObjectDefItem(StartAreaTreeID, "TreeMadrone", 1, 0.0);
	...
	rmAddObjectDefItem(StartDeerID11, "Deer", rmRandInt(13,14), 7.0);
...
int TopArea1 = rmCreatePieConstraint("Top area constraint",0.55,0.55, rmXFractionToMeters(0.0),rmXFractionToMeters(0.5), rmDegreesToRadians(315),rmDegreesToRadians(135));
int BottomArea1 = rmCreatePieConstraint("Bottom area constraint",0.45,0.45, rmXFractionToMeters(0.0),rmXFractionToMeters(0.5), rmDegreesToRadians(135),rmDegreesToRadians(315));
/*
   int TopArea = rmCreateArea("top area");
   rmSetAreaLocation(TopArea, 0.3, 0.3); 
   rmSetAreaSize(TopArea, 0.4, 0.4);
   rmSetAreaCoherence(TopArea, 1);
   rmSetAreaSmoothDistance(TopArea, 1);
   rmSetAreaObeyWorldCircleConstraint(TopArea, false);
   rmAddAreaConstraint(TopArea,BottomArea1);
   rmAddAreaToClass(TopArea, rmClassID("classPatch")); 
   rmSetAreaTerrainType(TopArea, "yukon\ground1_yuk");
   rmBuildArea(TopArea);*/

	int silverCount = PlayerNum/2*3; 
	int silverID3 = -1;
	int silverID4 = -1;
	...
	silverType = rmRandInt(1,10);
		...
		for(i=0; < silverCount)
	{
		silverID3 = rmCreateObjectDef("silver Top"+i);
		...
		rmAddObjectDefConstraint(silverID3, TopArea1);
		rmPlaceObjectDefAtLoc(silverID3, 0, 0.5, 0.5);		
   	}

	for(i=0; < silverCount)
	{
		silverID4 = rmCreateObjectDef("silver Bottom"+i);
		rmAddObjectDefItem(silverID4, "mine", 1, 0.0);
		rmSetObjectDefMinDistance(silverID4, 0.0);
		rmSetObjectDefMaxDistance(silverID4, rmXFractionToMeters(0.5));
		rmAddObjectDefConstraint(silverID4, avoidFastCoinTeam);
		rmAddObjectDefConstraint(silverID4, avoidAll);
		rmAddObjectDefConstraint(silverID4, avoidImpassableLand);
		rmAddObjectDefConstraint(silverID4, avoidTradeRouteSmall);
		rmAddObjectDefConstraint(silverID4, avoidSocketMore);
		rmAddObjectDefConstraint(silverID4, avoidCliffs);
		rmAddObjectDefConstraint(silverID4, BottomArea1);
  ...
  // RANDOM TREES
   ...
   {   
		...
		rmAddAreaConstraint(forest, LittleCircleCliff);
		...
		rmAddAreaConstraint(forest, ForestavoidCenter);
   ...
   {   
		...
		rmSetAreaForestType(forest2, "california madrone forest");
		...
		rmAddAreaConstraint(forest2, LittleCircleCliff);
		rmAddAreaConstraint(forest2, avoidAll);
		rmAddAreaConstraint(forest2, ForestavoidCenter);
   ...
   rmAddObjectDefItem(ElkID4, "Elk", rmRandInt(10,12), 8.0);
   ...
   rmAddObjectDefConstraint(ElkID4, avoidImpassableLand);
	...
	rmAddObjectDefConstraint(ElkID4, BottomArea1);
   rmSetObjectDefCreateHerd(ElkID4, true);
	rmPlaceObjectDefAtLoc(ElkID4, 0, 0.5, 0.5, PlayerNum/2*3);
	
	
		// Deer	
   int DeerID4=rmCreateObjectDef("Deer herd team");
   rmAddObjectDefItem(DeerID4, "Deer", rmRandInt(10,12), 8.0);
   ...
   rmAddObjectDefConstraint(DeerID4, avoidImpassableLand);
	...
	rmAddObjectDefConstraint(DeerID4, TopArea1);
    rmSetObjectDefCreateHerd(DeerID4, true);
	rmPlaceObjectDefAtLoc(DeerID4, 0, 0.5, 0.5, PlayerNum/2*3);	   
