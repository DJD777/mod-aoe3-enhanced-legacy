...
if (seasonPick == 1){
        ...
        rmSetAreaMix(continent2, "california_grass");
}
...
if (seasonPick == 2){
  	...
  	rmSetAreaMix(forest, "california_grassrocks");
       rmAddAreaInfluenceSegment(forest, 0.0, 0.0, 1.0, 1.0);
...
if (seasonPick >= 2){
		...
		rmAddObjectDefItem(Props, "UnderbrushRockies", rmRandInt(2,3), rmRandFloat(4.0,5.0));
