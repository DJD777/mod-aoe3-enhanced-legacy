...
//	rmSetMapElevationHeightBlend(1);
	...
	if (isObserverMode == true)
	{
		...
		{ //1v1
			rmSetRandomSpawn1v1(0.50,0.80,  0.50,0.20);
		}
		else if (rmGetPlayerTeam(2)!=rmGetPlayerTeam(3))
		{ // 2v2
			rmSetRandomSpawn2v2(0.42,0.83,  0.66,0.80,  0.34,0.20,  0.58,0.17);
		}
		else if (rmGetPlayerTeam(3)!=rmGetPlayerTeam(4))
		{ // 3v3
			rmSetRandomSpawn3v3(0.56,0.83,  0.74,0.74,  0.36,0.81,  0.26,0.26,  0.41,0.17,  0.64,0.19);
		}
	}
	else
	{
...
//	rmAddGroupingConstraint(nativeID3, avoidNatives);
	...
	rmAddObjectDefItem(playerTreeID, "Treegreatlakes", rmRandInt(5,5), 5.0);
...
//		rmSetAreaTerrainType(lakeforestID, "pampas\groundforest_pam");
		...
		for (j=0; < rmRandInt(10,12)) // 20,22
		{
			...
			if (i < 2)
				rmAddObjectDefItem(lakeforesttreeID, "ypTreeHimalayas", rmRandInt(2,3), 3.0);
			else
				rmAddObjectDefItem(lakeforesttreeID, "Treegreatlakes", rmRandInt(2,3), 3.0);
...
//		rmSetAreaTerrainType(plateauforestID, "pampas\groundforest_pam");
		...
		for (j=0; < rmRandInt(9,10)) // 20,22
		{
			...
			rmAddObjectDefItem(plateauforesttreeID, "ypTreeHimalayas", rmRandInt(2,4), 3.0);
...
//		rmSetAreaTerrainType(valleyforestID, "pampas\groundforest_pam");
		...
		for (j=0; < rmRandInt(9,10)) // 20,22
		{
			...
			rmAddObjectDefItem(valleyforesttreeID, "Treegreatlakes", rmRandInt(2,4), 3.0);
	...
	for (i=0; < 4+PlayerNum)
	{
		...
		rmAddObjectDefItem(randomtreeID, "Treegreatlakes", rmRandInt(3,5), 4.0);
