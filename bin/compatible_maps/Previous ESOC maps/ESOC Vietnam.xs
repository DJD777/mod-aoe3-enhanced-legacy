...
void main(void)
{
	...
	// Picks default terrain and water
		...
		rmSetBaseTerrainMix("araucania_grass_a"); 						// borneo_grass_a					// bayou_grass
		rmTerrainInitialize("water", 0.0); 		// borneo\ground_grass1_borneo		// bayou\ground1_bay		// araucania\ground_grass1_ara
	...
	// Resource avoidance
		...
		int avoidSaiga = rmCreateTypeDistanceConstraint("avoid Saiga", "ypSaiga", 45.0);
		int avoidSaigaShort = rmCreateTypeDistanceConstraint("avoid Saiga short", "ypSaiga", 30.0);
		int avoidSaigaMin = rmCreateTypeDistanceConstraint("avoid Saiga min", "ypSaiga", 5.0);
	...
	if (isObserverMode == true)
	{
		...
		{ //1v1
			rmSetRandomSpawn1v1(0.4, 0.25,  0.4, 0.75);
		}
		else if (rmGetPlayerTeam(2)!=rmGetPlayerTeam(3))
		{ // 2v2
			rmSetRandomSpawn2v2(0.35, 0.25, 0.60, 0.20,  0.35, 0.75, 0.60, 0.80);
		}
		else if (rmGetPlayerTeam(3)!=rmGetPlayerTeam(4))
		{ // 3v3
			rmSetRandomSpawn3v3(0.30, 0.30, 0.4625, 0.25, 0.625, 0.20,  0.30, 0.70, 0.4625, 0.75, 0.625, 0.80);
		}
	}
	else
	{
...
//	rmSetAreaMix(mainlandID, "araucania_grass_a");		// bayou_grass		// borneo_grass_a
	...
	rmSetAreaTerrainType(paintlandID, "araucania\ground_grass1_ara");
//	rmSetAreaMix(paintlandID, "araucania_grass_a");		// bayou_grass		// borneo_grass_a
...
//	rmSetAreaMix(nativezoneID, "testmix");	// for testing
	...
	for (i=0; < 12*PlayerNum) {
        ...
        rmSetAreaSize(patch1ID, rmAreaTilesToFraction(20), rmAreaTilesToFraction(10));
		rmSetAreaTerrainType(patch1ID, "araucania\ground_grass3_ara");		// borneo\ground_grass3_borneo		// bayou\ground3_bay
        ...
        rmSetAreaMaxBlobDistance(patch1ID, 20.0);
        rmSetAreaCoherence(patch1ID, 0.0);
		rmAddAreaConstraint(patch1ID, avoidPatch);
		rmAddAreaConstraint(patch1ID, avoidBlackmapMin);
	...
	for (i=0; < 6*PlayerNum) {
        ...
        rmSetAreaSize(patch2ID, rmAreaTilesToFraction(05), rmAreaTilesToFraction(10));
		rmSetAreaTerrainType(patch2ID, "bayou\ground5_bay");
		...
		rmAddAreaConstraint(patch2ID, avoidBlackmapMin);
		rmAddAreaConstraint(patch2ID, avoidWater);
	...
	if (rmGetIsKOTH() == true) {
		...
		rmSetAreaMix(kingislandID, "araucania_grass_a");
	...
	nativeID0 = rmCreateGrouping("Zen temple A", "native zen temple yr 0"+1); //+5
	...
	nativeID2 = rmCreateGrouping("Shaolin temple B", "native shaolin temple mongol 0"+2); //+1
	...
	nativeID1 = rmCreateGrouping("Shaolin temple C", "native shaolin temple mongol 0"+3);
	...
	nativeID3 = rmCreateGrouping("Zen temple D", "native zen temple yr 0"+2);
	...
	rmAddObjectDefItem(playerCrateID, "crateOfCoin", rmRandInt(1,2), 4.0);
	...
	rmAddObjectDefItem(playerTreeID, "ypTreeBorneo", rmRandInt(5,5), 5.0);
	...
	rmAddObjectDefItem(playerherdID, "ypSaiga", rmRandInt(10,10), 7.0);
	...
	rmAddObjectDefConstraint(playerherdID, avoidWater);
		
	// 2nd herd
	int playerherd2ID = rmCreateObjectDef("2nd herd");
    rmAddObjectDefItem(playerherd2ID, "ypwildelephant", rmRandInt(3,3), 6.0);
    rmSetObjectDefMinDistance(playerherd2ID, 25);
    rmSetObjectDefMaxDistance(playerherd2ID, 25);
    ...
    rmAddObjectDefItem(playerherd3ID, "ypwildelephant", rmRandInt(3,3), 5.0);
    rmSetObjectDefMinDistance(playerherd3ID, 35);
...
//		rmSetAreaMix(avoidisland11ID, "yellow_river_b");	// for testing
	...
	// Main forest patches
	int mainforestcount = 12+2*PlayerNum;
	...
	for (i=0; < mainforestcount)
    {
		...
		for (j=0; < rmRandInt(7,8))
		{
			...
			rmAddObjectDefItem(foresttreeID, "ypTreeBorneo", rmRandInt(1,2), 5.0);
			rmAddObjectDefItem(foresttreeID, "ypTreeCeylon", rmRandInt(0,1), 5.0);
	...
	// Secondary forest
	int secondforestcount = 20+2*PlayerNum;
	...
	for (i=0; < secondforestcount)
	{
		...
		for (j=0; < rmRandInt(5,6))
		{
			...
			rmAddObjectDefItem(secondforesttreeID, "ypTreeBorneo", rmRandInt(1,2), 5.0);
			rmAddObjectDefItem(secondforesttreeID, "ypTreeCeylon", rmRandInt(0,1), 5.0);
	...
	rmAddObjectDefItem(staticherdID, "ypSaiga", rmRandInt(10,10), 4.0);
	...
	rmAddObjectDefItem(staticherd2ID, "ypSaiga", rmRandInt(10,10), 4.0);
	...
	rmAddObjectDefItem(staticherd3ID, "ypSaiga", rmRandInt(10,10), 4.0);
	...
	rmAddObjectDefItem(staticherd4ID, "ypSaiga", rmRandInt(10,10), 4.0);
	...
	rmAddObjectDefItem(staticherd5ID, "ypSaiga", rmRandInt(10,10), 4.0);
	...
	rmAddObjectDefItem(staticherd6ID, "ypSaiga", rmRandInt(10,10), 4.0);
	...
	rmAddObjectDefItem(staticherd7ID, "ypSaiga", rmRandInt(10,10), 4.0);
	...
	rmAddObjectDefItem(staticherd8ID, "ypSaiga", rmRandInt(10,10), 4.0);
	...
	rmAddObjectDefItem(staticherd9ID, "ypSaiga", rmRandInt(10,10), 4.0);
	...
	rmAddObjectDefItem(staticherd10ID, "ypSaiga", rmRandInt(10,10), 4.0);
	...
	rmAddObjectDefItem(staticherd11ID, "ypSaiga", rmRandInt(10,10), 4.0);
	...
	if (PlayerNum > 2) {
		...
		for(i=0; < herdcount) {
			...
			rmAddObjectDefItem(saigaherdID, "ypSaiga", rmRandInt(10,10), 4.0);
	...
	// Berries 
	int NWberriescount = 2+1*PlayerNum/2;
	...
	int SEberriescount = 2+1*PlayerNum/2;
	...
	for (i=0; < 10+4*PlayerNum)
	{
		...
		rmAddObjectDefItem(randomtreeID, "ypTreeBorneo", rmRandInt(1,2), 3.0);
