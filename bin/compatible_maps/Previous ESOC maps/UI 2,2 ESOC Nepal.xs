...
void main(void)
{
	...
	if (isObserverMode == true)
	{
		...
		{ //1v1
			rmSetRandomSpawn1v1(0.75, 0.75,  0.25, 0.25);
		}
		else if (rmGetPlayerTeam(2)!=rmGetPlayerTeam(3))
		{ // 2v2
				rmSetRandomSpawn2v2(0.75, 0.75, 0.90, 0.50,  0.25, 0.25, 0.50, 0.10);
		}
		else if (rmGetPlayerTeam(3)!=rmGetPlayerTeam(4))
		{ // 3v3
				rmSetRandomSpawn3v3(0.70, 0.80, 0.90, 0.60, 0.90, 0.35,  0.20, 0.30, 0.40, 0.10, 0.65, 0.10);
		}
	}
	else
	{
...
//		rmSetAreaCliffHeight(playerareaID, 8, 0.25, 0.5);		
	...
	//	rmSetAreaMix(tradeislandID, "yellow_river_forest"); // for testing
	...
	//	rmSetAreaMix(nativeislandID, "yellow_river_forest"); // for testing
...
//	rmSetAreaMix(foothillsID, "testmix"); // for testing
	...
	rmSetAreaBaseHeight(foothillsID, 1.5);
	...
	rmSetAreaTerrainType(MountEbaseID, "rockies\groundsnow3"); // patagonia\ground_glacier_pat
	rmSetAreaCliffHeight(MountEbaseID, 9, 0.0, 0.2);
	...
	int MountE2ndID = rmCreateArea("Mount E 2nd Tier");
	rmSetAreaSize(MountE2ndID, 0.06, 0.06); 
	rmSetAreaWarnFailure(MountE2ndID, false);
	rmSetAreaObeyWorldCircleConstraint(MountE2ndID, false);
	rmSetAreaCliffType(MountE2ndID, "rocky mountain2"); 
	rmSetAreaTerrainType(MountE2ndID, "rockies\groundsnow3"); // patagonia\ground_glacier_pat
	rmSetAreaCliffHeight(MountE2ndID, 9, 0.0, 0.2);
	rmSetAreaCliffEdge(MountE2ndID, 1, 1.0, 0.0, 0.0, 1);
	rmSetAreaCoherence(MountE2ndID, 0.80);
	rmSetAreaSmoothDistance(MountE2ndID, 6);
	rmAddAreaToClass(MountE2ndID, rmClassID("Cliffs"));
	rmSetAreaLocation(MountE2ndID, 0.0, 1.0);
	rmBuildArea(MountE2ndID);

	int avoidMountETier2 = rmCreateAreaDistanceConstraint("avoid mount e tier2", MountE2ndID, 12.0);
	int avoidMountETier2Far = rmCreateAreaDistanceConstraint("avoid mount e tier2 far", MountE2ndID, 30.0);
	int stayMountETier2 = rmCreateAreaMaxDistanceConstraint("stay near mount e tier2", MountE2ndID, 8.0);
	
	int MountE3rdID = rmCreateArea("Mount E 3rd Tier");
	rmSetAreaSize(MountE3rdID, 0.055, 0.055); 
	rmSetAreaWarnFailure(MountE3rdID, false);
	rmSetAreaObeyWorldCircleConstraint(MountE3rdID, false);
	rmSetAreaCliffType(MountE3rdID, "rocky mountain2"); 
	rmSetAreaTerrainType(MountE3rdID, "rockies\groundsnow3"); // patagonia\ground_glacier_pat
	rmSetAreaCliffHeight(MountE3rdID, 9, 0.0, 0.2);
	rmSetAreaCliffEdge(MountE3rdID, 1, 1.0, 0.0, 0.0, 1);
	rmSetAreaCoherence(MountE3rdID, 0.80);
	rmSetAreaSmoothDistance(MountE3rdID, 6);
	rmAddAreaToClass(MountE3rdID, rmClassID("Cliffs"));
	rmSetAreaLocation(MountE3rdID, 0.0, 1.0);
	rmBuildArea(MountE3rdID);

	int avoidMountETier3 = rmCreateAreaDistanceConstraint("avoid mount e tier3", MountE3rdID, 12.0);
	int avoidMountETier3Far = rmCreateAreaDistanceConstraint("avoid mount e tier3 far", MountE3rdID, 30.0);
	int stayMountETier3 = rmCreateAreaMaxDistanceConstraint("stay near mount e tier3", MountE3rdID, 8.0);
	...
	rmSetAreaTerrainType(MountEsummitID, "rockies\groundsnow3"); // patagonia\ground_glacier_pat
	rmSetAreaCliffHeight(MountEsummitID, 9, 0.0, 0.2);
	...
	//	rmSetAreaMix(kingislandID, "yellow_river_forest"); // for testing
	...
	rmSetObjectDefMinDistance(playeherdID, 16);
    ...
    rmSetObjectDefMaxDistance(player2ndherdID, 20);
    ...
    rmSetObjectDefMaxDistance(player3rdherdID, 32);
	...
	rmSetObjectDefMinDistance(DuberID, 20.0);
	...
	for(i=0; < gold3count)	{
		...
		rmAddObjectDefConstraint(commongold1ID, avoidMountETier2);
		rmAddObjectDefConstraint(commongold1ID, avoidMountETier3);
...
//	rmSetAreaMix(goldzoneNID, "yellow_river_b");	// for testing
...
//	rmSetAreaMix(goldzoneSID, "yellow_river_b");	// for testing
	...
	//	rmSetAreaMix(nocliffs1ID, "yellow_river_b");	// for testing
	...
	//	rmSetAreaMix(nocliffs2ID, "yellow_river_b");	// for testing
	...
	//	rmSetAreaMix(nocliffs3ID, "yellow_river_b");	// for testing
	...
	//	rmSetAreaMix(nocliffs4ID, "yellow_river_b");	// for testing
	...
	//	rmSetAreaMix(nocliffs5ID, "yellow_river_b");	// for testing
	...
	//	rmSetAreaMix(nocliffs6ID, "yellow_river_b");	// for testing
	...
	//	rmSetAreaMix(nocliffs7ID, "yellow_river_b");	// for testing
	...
	//	rmSetAreaMix(nocliffs8ID, "yellow_river_b");	// for testing
	...
	for (i=0; < 12*PlayerNum)
    {
		...
		rmSetAreaTerrainType(patch1ID, "rockies\groundsnow5_roc");
	...
	for (i=0; < 12*PlayerNum) {
		...
		rmSetAreaTerrainType(patch2ID, "yellow_river\grass2_yellow_riv");
	...
	for (i=0; < 12+10*PlayerNum) {
		...
		rmSetAreaTerrainType(patch3ID, "rockies\groundsnow5_roc");
	...
	for (i=0; < 12+10*PlayerNum) {
		...
		rmSetAreaTerrainType(patch4ID, "rockies\groundsnow5_roc");
	...
	// Main Forest
	int mainforestcount = 14+4*PlayerNum;
	...
	rmAddObjectDefItem(staticherdID, "ypMarcoPoloSheep", rmRandInt(8,8), 3.0);
	...
	rmAddObjectDefItem(staticherd2ID, "ypMarcoPoloSheep", rmRandInt(8,8), 3.0);
	...
	rmAddObjectDefItem(staticherd3ID, "ypMarcoPoloSheep", rmRandInt(8,8), 3.0);
	...
	rmAddObjectDefItem(staticherd4ID, "ypMarcoPoloSheep", rmRandInt(8,8), 3.0);
	...
	rmAddObjectDefItem(staticherd5ID, "ypMarcoPoloSheep", rmRandInt(8,8), 3.0);
	...
	rmAddObjectDefItem(staticherd6ID, "ypMarcoPoloSheep", rmRandInt(8,8), 3.0);
	...
	rmAddObjectDefItem(staticherd7ID, "ypMarcoPoloSheep", rmRandInt(8,8), 3.0);
	...
	rmAddObjectDefItem(staticherd8ID, "ypMarcoPoloSheep", rmRandInt(8,8), 3.0);
	...
	// South Herds 
	int sheepherdcount = PlayerNum;
		
	for (i=0; < sheepherdcount) {
		int southherdID = rmCreateObjectDef("south herd"+i);
		rmAddObjectDefItem(southherdID, "ypMarcoPoloSheep", rmRandInt(8,8), 3.0);
	...
	// North Herds 
	int sheepherd2count = PlayerNum;
		
	for (i=0; < sheepherd2count) {
		int northherdID = rmCreateObjectDef("north herd"+i);
		rmAddObjectDefItem(northherdID, "ypMarcoPoloSheep", rmRandInt(8,8), 3.0);
	...
	int sheepherd3count = PlayerNum/2;
	...
	int sheepherd4count = PlayerNum/2;
	...
	for (i=0; < sheepherd4count)
	{
		...
		rmAddObjectDefConstraint(mountEherd2ID, stayMountETier3);
